...
const FEATURES = [
  { icon: "📢", title: "Signalement d'infractions", desc: "WhatsApp sécurisé reliant généralistes ruraux et spécialistes.s constatée sur les médias sénégalais." },
      ...
      <div style={{ minHeight:"100vh", background:"#080f20", color:"#fff", fontFamily:"system-ui,sans-serif", position:"relative", overflow:"hidden" }}>
        ...
        <header style={{ position:"sticky", top:0, zIndex:50, borderBottom:"1px solid rgba(255,255,255,0.06)",
          ...
          <div style={{ maxWidth:1100, margin:"0 auto", padding:"0 2rem", height:60, display:"flex", alignItems:"center", justifyContent:"space-between" }}>
            <div style={{ display:"flex", alignItems:"center", gap:10 }}>
              ...
              <div>
                <p style={{ fontSize:13, fontWeight:700, color:"#fff", margin:0 }}>Télé-Expertise</p>
                <p style={{ fontSize:9, color:COLOR, fontWeight:600, letterSpacing:"0.1em", textTransform:"uppercase", margin:0 }}>MSAS · Participation Télé-Expertisene</p>
              </div>
            </div>
        ...
        <footer style={{ borderTop:"1px solid rgba(255,255,255,0.06)", padding:"1.5rem 2rem", textAlign:"center" }}>
          <p style={{ fontSize:11, color:"rgba(255,255,255,0.2)", margin:0 }}>
            © 2025 MSAS · Télé-Expertise · Développé par <span style={{ color:"rgba(255,255,255,0.4)", fontWeight:600 }}>Processingenierie</span>
          </p>
        </footer>
      </div>
    </>
